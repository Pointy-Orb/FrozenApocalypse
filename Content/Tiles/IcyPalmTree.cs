...
public class IcyPalmTree : ModPalmTree
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        texture = ModContent.Request<Texture2D>("FrozenApocalypse/Content/Tiles/IcyPalmTree");
        topsTexture = ModContent.Request<Texture2D>("FrozenApocalypse/Content/Tiles/IcyPalmTree_Tops");
    }
